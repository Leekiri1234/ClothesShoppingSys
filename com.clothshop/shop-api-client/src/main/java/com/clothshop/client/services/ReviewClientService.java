...
public class ReviewClientService {
    ...
    private static final String HIDDEN_REVIEW_MESSAGE = "Đánh giá hiện bị ẩn.";
    ...
    public void submitReview(String username, ReviewCreateRequest request) {
        ...
        ProductFeedback feedback = ProductFeedback.builder()
                ...
                .feedbackStatus(STATUS_APPROVED) // Tự động duyệt hoặc để PENDING tùy logic
                .build();
    ...
    public PageResponse<ReviewResponse> getReviewsForProduct(Long productId, Pageable pageable) {
        Page<ProductFeedback> feedbackPage = feedbackRepository.findByProductIdAndFeedbackStatusInOrderByCreatedAtDesc(
                productId, List.of(STATUS_APPROVED, STATUS_HIDDEN), pageable);
